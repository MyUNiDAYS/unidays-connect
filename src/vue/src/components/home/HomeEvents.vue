    ...
    <div class="section events">
        <div class="container">
            <div class="power_heading_wrapper text-center">
                <h1 class="power_title ">
                    Through the year 2020 <br />
                    we've bunch of
                    <span class="primary-color">charity events</span>
                </h1>
                        ...
                        <div class="power_events_wrapper">
                            ...
                            <div class="power_events_content">
                                ...
                                <div class="power_events_bottom">
                                    ...
                                    <span
                                        >{{ seatsLeft(eventData[3]) }} seats
                                        left</span
                                    >
                                </div>
                                <h6 class="power_events_location">
                                    <i class="ion-ios-pin"></i> 23/4 RK Street,
                    ...
                    <div class="power_events_list">
                        <div class="power_events_list_wrapper">
                            ...
                            <div class="power_events_list_content">
                                <h6>
                                    <a href="#"
                                        >Healthy food campaign for children</a
                                    >
                                </h6>
                                <div class="power_events_list_date">
                                    15 April 2020
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="power_events_list">
                        <div class="power_events_list_wrapper">
                            ...
                            <div class="power_events_list_content">
                                <h6>
                                    <a href="#"
                                        >Fund collection for cancer research
                                        team</a
                                    >
                                </h6>
                                <div class="power_events_list_date">
                    ...
                    <div class="power_events_list">
                        <div class="power_events_list_wrapper">
                            ...
                            <div class="power_events_list_content">
                                <h6>
                                    <a href="#"
                                        >Challenges we face to establish
                                        school</a
                                    >
                                </h6>
                                <div class="power_events_list_date">
